...
# Author: Nima Shafie
# =============================================================================
# gcc-toolset/setup.sh
#
# Installs gcc-toolset-15 on RHEL 8 / Rocky Linux 8 from vendored RPMs.
# Provides GCC 15.1.1, G++, libstdc++ with GLIBCXX_3.4.30+, binutils 2.44.
#
# Linux only — no Windows component.
#
# USAGE:
#   bash gcc-toolset/setup.sh [--prefix <path>]
# =============================================================================
set -euo pipefail
...
case "$(uname -s)" in
  MINGW*|MSYS*|CYGWIN*)
    echo "[gcc-toolset] This module is Linux-only. Skipping on Windows."
    exit 0
    ;;
esac
...
install_mode_init "gcc-toolset" "${VERSION}"
install_log_capture_start

echo ""
echo "============================================================"
echo " gcc-toolset-15 — Setup"
